...
router.get('/goals/:goalId', (req, res, next) => {
	// req.params.goalId will be set based on the `:goalId` in the route
...
router.patch('/goals/:goalId', requireToken, removeBlanks, (req, res, next) => {
...
router.delete('/goals/:goalId', requireToken, (req, res, next) => {
	Goal.findById(req.params.goalId)
		.then(handle404)
		.then((goal) => {
